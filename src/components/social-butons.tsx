  ...
  return (
    <div className="flex items-center gap-2">
      <Button size="icon" variant="ghost" asChild>
        <a href="https://github.com/souorichard" target="_blank">
          <svg
            aria-hidden="true"
            height="24"
            viewBox="0 0 24 24"
      ...
      <Button size="icon" variant="ghost" asChild>
        <a href="https://www.linkedin.com/in/richdrodrigues/" target="_blank">
          <svg
      ...
      <Button size="icon" variant="ghost" asChild>
        <a href="https://www.instagram.com/souorichard_/" target="_blank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="#000000"
            width="800px"
